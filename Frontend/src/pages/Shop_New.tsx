...
const Shop = () => {
      ...
      try {
        ...
        setProducts([
          ...
          },
          {
            ...
            description: 'Move unseen through the world of the mundane.',
            quantity_in_stock: 8
          },
          {
            id: 'flame-crown-1',
            _id: 'flame-crown-1',
            name: 'Crown of Eternal Flame',
  ...
  // Animation effect on shop page load
  useEffect(() => {
    ...
    <div className="min-h-screen bg-deep-black text-white pt-20 pb-12">
      <div className="container mx-auto px-6">
        ...
        <div className="shop-header text-center mb-12 relative z-10">
          <h1 className="font-cinzel text-4xl md:text-5xl text-antique-gold mb-4 drop-shadow-lg">
            Sacred Marketplace
          </h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              {categories.map(category => (
                <option key={category._id} value={category._id} className="bg-deep-black">
                  {category.name}
                </option>
              ))}
            </select>
          ...
          {isLoading ? (
            ...
            <div className={`grid gap-6 ${
              ...
              {filteredProducts.map((product) => (
                <div
                  key={product.id}
                  className={`product-card group bg-ash-gray/30 rounded-lg overflow-hidden border border-ritual-red/20 hover:border-ritual-red/50 transition-all duration-500 backdrop-blur-sm ${
                    viewMode === 'list' ? 'flex' : ''
                  }`}
                >
                  {/* Image */}
          ...
          {!isLoading && !error && filteredProducts.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="font-cormorant text-gray-400">
                Try adjusting your search or filters to discover more artifacts.
              </p>
            </div>
          )}
        </div>
